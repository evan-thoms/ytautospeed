...
function initSpeedControl() {
    const oldPanel = document.getElementById('yt-speed-control');
  ...
  video.addEventListener('loadedmetadata', () => {
    ...
    function getExpansionDirection() {
      ...
      let direction = '';
      if (spaceRight >= expandedWidth) direction = 'right';
      else if (spaceLeft >= expandedWidth) direction = 'left';
      else direction = 'right';

      if (spaceDown >= expandedHeight) direction += '-down';
      else if (spaceUp >= expandedHeight) direction += '-up';
      else direction += '-down';
